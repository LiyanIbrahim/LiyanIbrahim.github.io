...
//`In ${townName2}, the ${adjective6} ${noun2} Inn hosted a night of uproarious comedy. A group of ${number3} lively ${occupation2}  checked in, and the ${adjective7} lobby echoed with infectious laughter.A hidden passageway led to a ${adjective8} ${location}, where ${number4} ${object3} surrounded by ${color} ${liquid} revealed a chilling truth. To break the curse, they ${action2} with ${element} and ${object4}, emerging at dawn, forever changed by the ${adjective9} horrors. The night ended with the group leaving, faces sore from laughter, creating legendary memories at the heart of ${townName2}`
...
const townName2 = document.getElementById('townName2').value;
 ...
 const adjective7 = document.getElementById('adjective7').value;
  ...
  const stories = {
    horror: ``,
    comedy: `In ${townName2}, the ${adjective6} ${noun2} Inn hosted a night of uproarious comedy. A group of ${number3} lively ${occupation2}  checked in, and the ${adjective7} lobby echoed with infectious laughter.A hidden passageway led to a ${adjective8} ${location}, where ${number4} ${object3} surrounded by ${color} ${liquid} revealed a chilling truth. To break the curse, they ${action2} with ${element} and ${object4}, emerging at dawn, forever changed by the ${adjective9} horrors. The night ended with the group leaving, faces sore from laughter, creating legendary memories at the heart of ${townName2}`
