...
arrow.addEventListener('click', event => {
	...
	if(pair==2 ){
		...
		title.innerText = 'Environment';
		title.style.color="#ff6210";
		_ELEMENT.style.color="#002a8b";
		_CURSOR.style.color="#002a8b";
	...
	if(pair==3 ){
		title.innerText = 'Activism';
		title.style.color="#d7143c";
		_ELEMENT.style.color="#00b067";
		_CURSOR.style.color="#00b067";
		pair11.style.display="none";
	...
	if(pair==4 ){
		...
		title.style.color="#f7a8b8";
		_ELEMENT.style.color="#55cdfc";
		_CURSOR.style.color="#55cdfc";
		pair11.style.display="none";
		pair21.style.display="none";
		pair31.style.display="none";
	...
	if(pair==5 ){
		title.innerText = 'Religion';
		title.style.color="#e9b03c";
		_ELEMENT.style.color="#c5ced3";
		_CURSOR.style.color="#c5ced3";
		pair11.style.display="none";
		pair21.style.display="none";
		pair31.style.display="none";
		pair41.style.display="none";
